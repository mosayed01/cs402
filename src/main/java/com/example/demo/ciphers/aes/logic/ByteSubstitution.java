...
public final class ByteSubstitution {
    ...
    public static int[][] substitute(int[][] state) {
    ...
    private static int[][] getNewState(int[][] state, int[][] substitutionTable) {
        ...
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
                ...
                result[i][j] = substitutionTable[row][col];
            }
        }
        return result;
    ...
    public static void main(String[] args) {
        ...
        int[][] result = substitute(state);


        System.out.println("\nSubstituted state:");
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
                System.out.printf("%02x ", result[i][j]);
            }
            System.out.println();
        }
